...
--
-- Host: localhost:3306
-- Generation Time: Feb 20, 2023 at 09:57 AM
...
(1, 'pbkdf2_sha256$390000$HO0Y9Qd7aIZqQsKRQZYy3W$ywk+YtAWJwVpXT9h7nP+YHaZX781SO5yffnomfaT3Co=', '2023-02-20 03:43:35.731211', 1, 'ratulhasan', '', '', '', 1, 1, '2023-02-19 14:49:44.525264');
...
INSERT INTO `base_user` (`id`, `username`, `bio`, `company_id`, `stack`, `profile_pic`, `social_link`, `name`) VALUES
(1, 'ch0wdhuryshaheb', 'Python | Flask | FastAPI | JavaScript | ML Enthusiast', 2, 'Python', 'uploads/avatar_u0hmEMY.png', 'https://www.linkedin.com/in/hasib404/', 'Hasibul Hasan'),
(2, 'ratulhasanshaon', 'software engineer ( python | django )', 1, 'Python || Django', 'uploads/avatar_aTR7Ctx.png', 'https://twitter.com/ratulhasanshaon', 'Ratul Hasan'),
(3, 'tauratislam', 'Two years experienced full-stack software engineer with sophisticated interpersonal and multitasking capabilitie', 1, 'php | ajax | laravel', 'uploads/avatar_L5TJR60.png', 'https://www.linkedin.com/in/tauratislam/', 'Thorat Islam'),
(4, 'barshadas', 'Developer Advocate \r\n@EvmuxStudio', 3, 'DataScience', 'uploads/avatar_TUot1BN.png', 'https://twitter.com/thebarshablog', 'Asmaul Hosna'),
(5, 'francescoCiull4', 'Developer Advocate at \r\n@dailydotdev\r\n· Docker Captain\r\n· Public Speaker', 3, 'Docker', 'uploads/avatar_bhnoP9X.png', 'https://twitter.com/FrancescoCiull4', 'Ashraful Zaman'),
(6, 'dev_neil_a', 'Consultant/SysAdmin of 20+ years, now learning to #code.', 2, 'python', 'uploads/avatar_NEqK0Ke.png', 'https://twitter.com/dev_neil_a', 'Intiser Zaman');
...
(14, '2023-02-20 04:25:47.026119', '4', 'barshadas', 1, '[{\"added\": {}}]', 7, 1),
(15, '2023-02-20 04:26:48.433706', '5', 'francescoCiull4', 1, '[{\"added\": {}}]', 7, 1),
(16, '2023-02-20 04:28:14.765858', '6', 'dev_neil_a', 1, '[{\"added\": {}}]', 7, 1),
(17, '2023-02-20 05:14:13.572241', '2', 'ratulhasanshaon', 2, '[{\"changed\": {\"fields\": [\"Bio\", \"Social link\"]}}]', 7, 1),
(18, '2023-02-20 05:14:48.168969', '1', 'Ch0wdhuryShaheb', 2, '[{\"changed\": {\"fields\": [\"Username\"]}}]', 7, 1),
(19, '2023-02-20 05:15:04.201554', '1', 'Ch0wdhuryShaheb', 2, '[{\"changed\": {\"fields\": [\"Bio\"]}}]', 7, 1),
(20, '2023-02-20 06:33:01.721104', '1', 'ch0wdhuryshaheb', 2, '[{\"changed\": {\"fields\": [\"Username\"]}}]', 7, 1),
(21, '2023-02-20 08:02:15.693576', '2', 'ratulhasanshaon', 2, '[{\"changed\": {\"fields\": [\"Name\"]}}]', 7, 1),
(22, '2023-02-20 08:02:29.717609', '6', 'dev_neil_a', 2, '[{\"changed\": {\"fields\": [\"Name\"]}}]', 7, 1),
(23, '2023-02-20 08:03:57.302207', '4', 'barshadas', 2, '[{\"changed\": {\"fields\": [\"Name\"]}}]', 7, 1),
(24, '2023-02-20 08:04:02.053597', '1', 'ch0wdhuryshaheb', 2, '[{\"changed\": {\"fields\": [\"Name\"]}}]', 7, 1),
(25, '2023-02-20 08:04:11.613385', '3', 'tauratislam', 2, '[{\"changed\": {\"fields\": [\"Name\"]}}]', 7, 1),
(26, '2023-02-20 08:04:22.924907', '5', 'francescoCiull4', 2, '[{\"changed\": {\"fields\": [\"Name\"]}}]', 7, 1),
(27, '2023-02-20 08:05:42.836925', '2', 'ratulhasanshaon', 2, '[]', 7, 1),
(28, '2023-02-20 08:06:16.212348', '2', 'ratulhasanshaon', 2, '[{\"changed\": {\"fields\": [\"Social link\"]}}]', 7, 1),
(29, '2023-02-20 08:07:32.675893', '2', 'ratulhasanshaon', 2, '[{\"changed\": {\"fields\": [\"Bio\"]}}]', 7, 1);
...
(24, 'base', '0006_user_name_alter_user_bio_alter_user_profile_pic_and_more', '2023-02-20 05:07:33.693950');
...
('lcqy7jzwyf9m42wwasjy59484dwasjd7', '.eJxVjMsOwiAQRf-FtSE8pGVcuu83kBkYpGogKe3K-O_apAvd3nPOfYmA21rC1nkJcxIXocXpdyOMD647SHestyZjq-syk9wVedAup5b4eT3cv4OCvXxrZRk8QgbKfojx7CipTISoM7IZvNZajWAwghuNs9YTJGN1AgCk6Fi8P_nZODo:1pTx5T:_CfOk7FtJ3ieSDETBf6nBmC2Pby4x-yfoKwwn_n6tL0', '2023-03-06 03:43:35.835270'),
